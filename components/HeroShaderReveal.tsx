...
export function HeroShaderReveal({
  ...
  useEffect(() => {
    ...
    const compositionUniforms = {
      ...
      uColorHover: { value: new THREE.Color("#ffffff") },
      ...
      COLOR_OUTLINE: { value: new THREE.Color("#f4f6fe") },
      COLOR_FOREGROUND: { value: new THREE.Color("#f4f6fe") },
      COLOR_BACKGROUND: { value: new THREE.Color("#0e214f") },
      COLOR_CURSOR_FOREGROUND: { value: new THREE.Color("#f4f6fe") },
      COLOR_CURSOR_BACKGROUND: { value: new THREE.Color("#0e214f") },
      COLOR_CURSOR_OUTLINE: { value: new THREE.Color("#f4f6fe") },
      COLOR_FILTER: { value: new THREE.Color("#17294f") },
    };
